...
class Trainer:
    ...
    def __init__(
        ...
        for p in self.model.module.collect_params().values():
            p.grad_req = 'add'
    ...
    def start(self):
        ...
        if os.path.exists(latest_file):
            ...
            self.model.module.load_parameters(f'{self.save_dir}/{params_file}')
        for epoch in range(start_epoch, start_epoch + self.epochs):
            ...
            self.model.module.save_parameters(f'{self.save_dir}/{params_file}')
            latest = {
                'epoch': epoch,
